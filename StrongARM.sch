...
C {devices/code_shown.sym} 2770 -1290 0 0 {name=SPICE only_toplevel=false value="
.control
save all
tran 10p 6000n 
plot VINdiff VIN VIN2
plot VINdiff VOUTdiff 
.endc"
}
...
C {devices/vsource.sym} 2220 -1250 0 0 {name=V3 value="sin(1 1 0.5Meg)"}
C {devices/lab_wire.sym} 2220 -1360 0 0 {name=p1 sig_type=std_logic lab="VIN"}
...
C {devices/vsource.sym} 2660 -1250 0 0 {name=V4 value="sin(1 0.5 0.5Meg 500n)"}
